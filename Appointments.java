...
public class Appointments {
    ...
    /**
     * ************************************************
     * selectDB()gets one customer appointment from the DB
     * ************************************************
     */
    public void selectDB(String Cid) {
        ...
        try {
            ...
            Connection con1;
            con1 = DriverManager.getConnection("jdbc:ucanaccess://C://Users//Professor Ajibogun/Downloads/CTCNailSalonMDB.accdb");
    ...
    /**
     * ***************************************************
     * insertDB()inserts one customer appointment into the DB
     * ****************************************************
     */
    ...
    /**
     * ******************************************************
     * updateDB()updates one customer appointment from the DB
     * *******************************************************
     */
    public void updateDB() {
        ...
        try {
            Class.forName("net.ucanaccess.jdbc.UcanaccessDriver");
            Connection con1 = DriverManager.getConnection("jdbc:ucanaccess://C:/Users/Professor Ajibogun/Downloads/CTCNailSalonMDB.accdb");
    ...
    /**
     * ************************************************
     * DeleteDB()deletes one customer appointment from the DB
     * ************************************************
     */
